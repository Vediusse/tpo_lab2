...
def plot_comparison(frame: pd.DataFrame, stem: str, png_path: Path, title: str) -> None:
    ...
    analytical_values = analytical_function(stem, x_values)
    ...
    apply_reasonable_limits(approx_values, analytical_values)
    plt.title(title)
    plt.xlabel("x")
    plt.ylabel("result")
