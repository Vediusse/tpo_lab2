...
def plot_system_functions(input_dir: Path, output_dir: Path) -> None:
    ...
    try:
        ...
        system_path = resolve_csv_path(input_dir, "system")
        kind = "table stub" if system_path is not None and series_kind(input_dir, system_path) == "table stub" else "approximation"
